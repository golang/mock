...
func (m *MockIndex) ReflectValue(arg0 reflect.Value) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ReflectValue", arg0)
}

// ReflectValue indicates an expected call of ReflectValue
func (mr *MockIndexMockRecorder) ReflectValue(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReflectValue", reflect.TypeOf((*MockIndex)(nil).ReflectValue), arg0)
}
